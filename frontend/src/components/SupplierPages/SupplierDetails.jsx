...
function SupplierDetails() {
  ...
  const columns = ['#', 'Supplier Name', 'Supplier Address', 'NIC', 'Email', 'Contact 1', 'Contact 2', 'Status', 'View'];
    ...
    try {
      ...
      const formattedData = supplier.map(supplier => [
        ...
        <div className='d-flex' style={{ justifyContent: 'center' }}>
          <button className='btn btn-info' onClick={() => handleViewClick(supplier.supplierId, supplier.supplierName || 'unknown')} ><Eye /> View </button>
        </div>
      ]);
