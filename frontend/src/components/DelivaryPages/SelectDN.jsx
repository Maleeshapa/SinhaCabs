              ...
              <section className="billing-details ">
                ...
                <div className="invoice-info">
                  ...
                  <div className="details mb-2">
                    ...
                    <input
                      type="text"
                      className="form-input bg-warning"
                      name="invoiceNo"
                ...
                <div className="options">
                  ...
                  <div className="payment-form-button  d-grid d-md-flex me-md-2 justify-content-end px-5">
                    <Link to='/sales/delivery'><button className='btn btn-danger'>Cancel</button></Link>
                    <button onClick={handlePrint} className='btn btn-warning'>Create Delivery Note</button>
                  </div>
                </div>
              </section>
