...
INSERT INTO `customer` (`cusId`, `cusName`, `cusCode`, `cusAddress`, `cusPhone`, `cusJob`, `cusEmail`, `nic`, `license`, `customerReview`, `customerDescription`, `guarantorId`) VALUES
(6, 'kavindu  Z', 'cus002', 'Hunnasgiriya Z', '1234567895 Z', 'kada Z', 'kavindu@gmail.com', 'nicZ', 'liceneZ', 'Bad', '', NULL),
...
(2, 2, 14, 'tire', '2025-02-12', 500),
(3, 1, 14, 'gas', '2025-02-11', 100);
...
(14, 'Car  2', 'cn-1000', 'CN-5000', NULL, 500, '', NULL, 'hi', NULL, 'In stock', 'rent', 1),
(15, 'van 1', 'p1', '', NULL, 8000, '', NULL, '', NULL, 'In stock', NULL, 1),
(16, 'Car  2ttt', '777', '777', NULL, 777, '', NULL, '777', NULL, 'In stock', 'rent', 2),
(17, '7777', '777888', '777', NULL, 7777, '', NULL, '777', 'http://localhost:5000/uploads/products/7777_1738743832054.jpg', 'In stock', 'hire', 1),
(18, 'car test', 'car test 123', 'CN-car test', NULL, 8000, '', NULL, 'car test', NULL, 'In stock', 'hire', 1),
...
(20, 14, 1, 18, '2025-02-11 15:45:13', '', NULL, 14, 'pending', 'hire', '', '2025-02-11 15:45:13', '2025-02-11 15:45:13'),
(27, 14, 1, 14, '2025-02-28 00:00:00', '', NULL, 21, 'pending', 'rent', '', '2025-02-13 13:45:32', '2025-02-13 14:23:53');
...
INSERT INTO `transactions` (`transactionId`, `salesId`, `price`, `extraCharges`, `totalAmount`, `paymentType`, `paidAmount`, `due`, `pId`, `createdAt`, `updatedAt`) VALUES
(11, 17, 8000, 0, 8000, '', 0, 8000, NULL, '2025-02-11 15:16:24', '2025-02-11 15:16:24'),
(13, 19, 8000, 0, 8000, 'online', 0, 8000, NULL, '2025-02-11 15:18:46', '2025-02-11 15:18:46'),
(14, 20, 8000, 0, 8000, 'cash', 0, 8000, NULL, '2025-02-11 15:45:13', '2025-02-11 15:45:13'),
(21, 27, 6000, 0, 6000, 'cash', 6800, -800, 14, '2025-02-13 13:45:32', '2025-02-13 14:50:25');
...
--
ALTER TABLE `customer`
  MODIFY `cusId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `guarantor`
  MODIFY `guarantorId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
ALTER TABLE `sales`
  ...
  ADD CONSTRAINT `fk_sales_transactionId` FOREIGN KEY (`transactionId`) REFERENCES `transactions` (`transactionId`) ON DELETE CASCADE;
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`salesId`) REFERENCES `sales` (`salesId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`pId`) REFERENCES `products` (`productId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
