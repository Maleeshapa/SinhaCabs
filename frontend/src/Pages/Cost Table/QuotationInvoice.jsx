                        ...
                        <div id="invoice-card">
                            ...
                            <footer className="invoice-footer" style={{ textAlign: 'left', color: 'black', fontSize: 'small', paddingLeft: '20px', marginTop: '20px' }}>
                                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
                                    ...
                                    <li>Payment mode: Cash or cheque. All cheques are to be drawn in favour of {colkan ? "Colkan Holdings (Pvt) Ltd" : haman ? "Haman" : terra ? "Terra Walkers" : "[Insert Company Name]"} and crossed account payee only payee only.</li>
                                    <li> <b>
                                        ...
                                        {terra && (
                                            <>
                                                Bank: Sampath Bank | Account Number: 0117 1000 1407 | Account Name: Terra Walkers | Branch Name: Kirulapona
                                            </>
                                        )} </b>
                                    </li>
